...
const PostPage = ({ params }) => {
  ...
  const handleSubmitReply = async () => {
    if (!user) {
      ...
      router.push(
        `/auth/login/?return=/${params.username}/post/${params.path}`
      );
      return;
    }
    if (!replyContent) {
          ...
          <div className="post_header_info">
            {postData.type == "post" ? (
              ...
              <small>
                Em resposta à
                <a
                  href={`/${parentData?.author}/${parentData?.path}`}
            ...
            <div className="post_footer">
              ...
              <a
                href="#replies"
                className={`btn icon${postReplies.length > 0 && "-label"}`}
              >
                <ChatTeardrop />
                ...
                {auth.currentUser ? (
                  isOwnProfile ? (
                    ...
                    <a
                      ...
                      href={`/${username}/post/${path}/report`}
                    >
                      Denunciar
                      <Warning />
                    </a>
                  ...
                  <a
                    href={`/auth/login?redirect=/${username}/post/${path}`}
                    className="btn icon-label danger"
                  >
